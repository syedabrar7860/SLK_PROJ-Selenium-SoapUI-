...
public class ChromeDemo
{
	...
	public static void main(String[] args) throws Exception
	{
		...
		xlRead("D:\\TR soft\\Selenium Jars\\Google.xls");
		for(int i=1;i<xlRows;i++)
		{
			if(xData[i][1].equalsIgnoreCase("Y"))
			{
				...
				myD.findElement(By.name("q")).sendKeys(vSearch);
				myD.findElement(By.name("btnK")).click();
				xData[i][3]=(myD.getTitle());
				Thread.sleep(3000);
				...
				{
					xData[i][4]="FAIL";
					Files.copy(scrFile, new File("D:\\TR soft\\Sel_SS\\pic"+i+".png"));
					xData[i][5]=("D:\\TR soft\\Sel_SS\\pic"+i+".png");
		...
		xlwrite("D:\\\\TR soft\\\\Selenium Jars\\\\Final.xls",xData);
	}
